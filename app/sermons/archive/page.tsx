      ...
      <div className="max-w-6xl mx-auto px-4 space-y-10">
        <header className="space-y-4 text-center">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Browse past services, teachings, and special Sundays. Search by speaker, topic, or date and watch immediately on demand.
          </p>
        </header>
            ...
            >
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {sermon.tags.map((tag) => (
                    <span key={tag} className="px-3 py-1 rounded-full bg-white/10 text-xs uppercase tracking-widest text-red-200">
                      {tag}
                    </span>
                  ))}
                </div>
